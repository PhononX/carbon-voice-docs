...
After tapping the purple check mark to finish your recording, you'll see a few quick
actions you can take.

## 1. Choose an AI action (optional)
...
You can share a voice message in a few ways:

- **Send it to a person** using their email address or phone contact.
- **Post it in a conversation.**
- **Generate a shareable link** — anyone with the link can listen, reply, and engage.
