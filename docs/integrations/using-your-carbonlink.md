---
title: Using and sharing your CarbonLink
description: Edit your CarbonLink, share it as a link or QR code, and put it where people already look for you.
sidebar_position: 3
---
...
- **Settings** — change your photo or the URL of your CarbonLink.
- **Send messages to** — choose which workspace conversations get started in.
- **Tracking tag** — track where people found your link.
...
- Printed on a business card or flyer, so someone can scan the QR code.
- As a reply to LinkedIn messages or cold emails asking to schedule a call.
- Embedded on an e-commerce or app site, instead of building a contact center.
- On a link-in-bio page, so followers can send feedback and talk.
- As a "respond with text" option when someone calls you.

## Why people take you up on it
...
- [Get your personal CarbonLink](../account-and-settings/personal-carbonlink.md)
- [Claim your username](../account-and-settings/claim-your-username.md)
