...
- Tap the microphone to **record a new voice memo** that you can save, share, or send
  to a conversation.
- Tap a **Quick Send** conversation tile.
- **Swipe left to right** on any conversation card.
- **Tap the "+"** to send a direct message, create a named conversation, or start an
  async meeting.
