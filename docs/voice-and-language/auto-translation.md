...
Global Voice lets a conversation work across languages, so nobody has to simplify their
ideas into a shared language or slow down hunting for the right words. Messages are
translated when needed, and everyone follows along in the language they prefer.

> Carbon Voice Translate must be enabled for your account or workspace.
...
Translation happens when someone with Carbon Voice Translate needs to understand
others, or needs others to understand them. If nobody in a conversation has it enabled,
nothing is translated.

Take a conversation where User A speaks English and has Translate enabled, alongside
...
So Translate provides translation to and from User A's language, and others who share
that language benefit as a side effect.
...
Press and hold a message card to see the other languages available for it, including
the original.
...
New accounts start on a limited-time premium trial, and the first five auto-translated
messages use your preserved speaker voice for free.

- **Individually** — upgrade through the plan details in Settings.
- **For a team** — see [pricing](https://www.getcarbon.app/pricing) and contact
  [sales@getcarbon.app](mailto:sales@getcarbon.app).
