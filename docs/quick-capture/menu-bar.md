...
description: Record, play, and reach your conversations from the macOS menu bar.
sidebar_position: 3
---
...
- **Record and send** without bringing the main window forward.
- **Play** what's waiting for you.
- **Reach your speed dial destinations** directly.
